...
var historialDolar = _interopRequireWildcard(require("../controllers/historial_dolar.controller"));
...
router.get('/all', historialDolar.getAllHistorialDolar); // historialDolar/:id
