...
var movimientos = _interopRequireWildcard(require("../controllers/movimientos.controller"));
...
router.get('/all', movimientos.getAllMovimientosWithFalse); // movimientos/:id
