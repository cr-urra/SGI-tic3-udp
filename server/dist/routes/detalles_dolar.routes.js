...
var detallesDolar = _interopRequireWildcard(require("../controllers/detalles_dolar.controller"));
...
router.get('/all', detallesDolar.getAllDetallesDolarWithFalse); // detallesDolar/:id
