...
var unidadProductos = _interopRequireWildcard(require("../controllers/unidad_productos.controller"));
...
router.get('/all', unidadProductos.getAllUnidadProductosWithFalse); // unidadProductos/:id
