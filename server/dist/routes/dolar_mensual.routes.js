...
var dolarMensual = _interopRequireWildcard(require("../controllers/dolar_mensual.controller"));
...
router.get('/all', dolarMensual.getAllDolarMensualWithFalse); // dolarMensual/:id
