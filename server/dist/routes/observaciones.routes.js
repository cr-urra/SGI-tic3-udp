...
var observaciones = _interopRequireWildcard(require("../controllers/observaciones.controller"));
...
router.get('/all', observaciones.getAllObservacionesWithFalse); // observaciones/:id
