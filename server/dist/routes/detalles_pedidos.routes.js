...
var detallesPedidos = _interopRequireWildcard(require("../controllers/detalles_pedidos.controller"));
...
router.get('/all', detallesPedidos.getAllDetallesPedidosWithFalse); // detallesPedidos/:id
