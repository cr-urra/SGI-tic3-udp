...
var bancosAgentesAduana = _interopRequireWildcard(require("../controllers/bancos_agentes_aduana.controller"));
...
router.get('/all', bancosAgentesAduana.getAllBancosAgentesAduanaWithFalse); // bancosAgentesAduana/:id
