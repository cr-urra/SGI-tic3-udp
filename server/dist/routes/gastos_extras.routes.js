...
var gastosExtras = _interopRequireWildcard(require("../controllers/gastos_extras.controller"));
...
router.get('/all', gastosExtras.getAllGastosExtrasWithFalse); // gastosExtras/:id
