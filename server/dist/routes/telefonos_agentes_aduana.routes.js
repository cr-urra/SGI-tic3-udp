...
var telefonosAgentesAduana = _interopRequireWildcard(require("../controllers/telefonos_agentes_aduana.controller"));
...
router.get('/all', telefonosAgentesAduana.getAllTelefonosAgentesAduanaWithFalse); // telefonosAgentesAduana/:id
