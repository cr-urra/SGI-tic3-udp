...
var observadores = _interopRequireWildcard(require("../controllers/observadores.controller"));
...
router.get('/all', observadores.getAllObservadoresWithFalse); // observadores/:id
