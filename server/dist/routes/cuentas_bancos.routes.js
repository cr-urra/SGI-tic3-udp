...
var cuentasBancos = _interopRequireWildcard(require("../controllers/cuentas_bancos.controller"));
...
router.get('/all', cuentasBancos.getAllCuentasBancosWithFalse); // cuentasBancos/:id
