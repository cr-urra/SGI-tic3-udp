...
COPY public.proveedores (id, nombre, direccion, correo, pais, monedas_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.cuentas_bancos_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.cuentas_corrientes_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.detalles_dolar_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.dolar_mensual_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.historial_dolar_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.numeros_aba_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.telefonos_agentes_aduana_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.telefonos_proveedores_id_seq', 1, false);
