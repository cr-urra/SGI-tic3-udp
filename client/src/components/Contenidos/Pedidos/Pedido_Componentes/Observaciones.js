                ...
                <Accordion.Collapse eventKey="0">
                  <Card.Body>                                                                           
                    <ul class="list-group list-group-flush">
                      ...
                      <Observacion fecha={"Fecha A"} descripcion={"Descripcion A"}/>
                      <Observacion fecha={"Fecha B"} descripcion={"Descripcion B"} />
                      <Observacion fecha={"Fecha C"} descripcion={"Descripcion C"} />
